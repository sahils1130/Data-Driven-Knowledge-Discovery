...
Looking up the best K value possible from the range 1 to 50. Here the best K values with less error rate are 11 and 15. We are gonna select the maximum K, as it has the least possible chance of overfitting.
